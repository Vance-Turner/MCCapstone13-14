...
def createTunnel(fileName, kwargs, doGUI=False,doMeshing=True,killSalomeAfter=True):
    ...
    try:
        ...
        if doMeshing:
            ...
            numOfSegmentsRatio = 90.0/3.0
            maxAreaTunnelRatio = 5.0/3.0
            maxAreaDiskRatio = 2.0/3.0
            numOfSegments = round(numOfSegmentsRatio*tunnelMaxSize)
            ...
            MaxArea2D_5 = MEFISTO_2D.MaxElementArea(maxAreaTunnelRatio*tunnelMaxSize)
            NETGEN_3D = TunnelSansDisk.Tetrahedron()
            Max2D_3 = smesh.CreateHypothesis('MaxElementArea')
            Max2D_3.SetMaxElementArea( tunnelMaxSize )
            ...
            MaxSize_1D_2.SetLength( maxAreaDiskRatio*tunnelMaxSize )
...
#     defaultMap = json.load(open(jsonFile,'r'))
    ...
    "tunnelHeight": 80.0, "tunnelRadius": 50.0,
    "diskHeight": 1.0, "diskRadius": 13.0,
    "tunnelMaxSize": 2.0, "shroudPoints":[[30,5],[35,10],[39,14],[41,14],[45,17.5],[55,15]],"shroudThickness":0.25,
